...
from emcfsys.EMCellFound.datasets.classification_folder import (
...
def main() -> None:
    ...
    print("KNN uses deterministic resize + normalization without random augmentation.")
    ...
    checkpoint_path = args.save_dir / "classification_knn_cv_final.pth"
