...
class TimmViTFeatureExtractor(nn.Module):
    """timm ViT feature extractor for KNN classification."""
    ...
    def __init__(
        ...
        try:
            ...
            raise ImportError(
                "KNN_ImageNet.py requires the timm package. "
...
def fit_knn(
    *,
    feature_extractor: TimmViTFeatureExtractor,
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            "KNN classification demo with a timm ImageNet ViT-Base backbone. "
    ...
    parser.add_argument("--feature-type", choices=("cls", "mean"), default="cls")
        ...
        json.dumps(
            {
                "task": "classification",
                "head_name": HEAD_KNN,
                "feature_backbone": "timm_imagenet_vit",
