...
![alt text](image-2.png)
   - Image Resize function: Resize the selected image to any other size
    1. The GUI of the Resize funciton![alt text](image-3.png)
    2. You can select the resize algorithm, use bilinear by default![alt text](image-4.png)
    3. Also, you can resize by scale ![alt text](image-5.png)
...
1. Deep learning training funcion
   ...
   1. Select backbone![alt text](image-10.png)
   2. Select the segment head, default Unet![alt text](image-11.png)
...
2. Deep Learning model Inference funcion
   ...
   2. Now, load the model.![alt text](image-13.png)
...
- One approach is to perform inference on a single image or a small stack of images. See **Single Image Inference**![alt text](image-14.png)
- Another approach is to perform inference on a large batch of images in a folder. See **Batch Inference**![alt text](image-15.png)
